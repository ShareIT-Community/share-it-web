...
// Script para ejecutar pruebas de penetración
const { runPenetrationTests, generateSecurityReport, testSpecificField, penetrationPayloads } = require('../src/components/SocialLinks/schema/penetrationTests.ts');
...
if (args.includes('--help') || args.includes('-h')) {
  console.log('Uso: node penetration-test.js [opciones]');
  console.log('');
  ...
  console.log('  node penetration-test.js');
  console.log('  node penetration-test.js --field email');
  console.log('  node penetration-test.js --category xss');
  process.exit(0);
}
