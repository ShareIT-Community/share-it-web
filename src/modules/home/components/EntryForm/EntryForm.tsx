...
export const EntryForm: React.FC<EntryFormProps> = ({ onClose }) => {
	...
	return (
		<form
			...
			<h2 className='mb-2 md:mb-5 text-2xl md:text-3xl font-bold flex text-center justify-center items-center pr-8 md:pr-0'>
			...
			<button
				type='button'
				onClick={onClose}
				className='w-8 h-8 bg-red-500 hover:bg-red-600 hover:text-black cursor-pointer top-5 right-5 md:top-8 md:right-8 text-white rounded-full transition absolute flex items-center justify-center z-10'>
